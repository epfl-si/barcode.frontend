      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col items-center md:flex-row md:items-start md:justify-between gap-6">
          <div className="w-full border-t pt-4 flex flex-col items-center md:flex-row md:items-center md:justify-between gap-3">
            <div className="flex flex-wrap justify-center md:justify-start gap-x-4 gap-y-1 text-sm flex-row">
              ...
              <div className="flex flex-row items-center text-gray-500"><Mail className="m-2"/>{config.supportEmail}</div>
              <div className="flex flex-row items-center text-gray-500"><Phone className="m-2"/>{config.telephone}</div>
            </div>
